...
| Caio Antônio | 1. Participação nas etapas da Design Sprint, 2. Elaboração de artefatos como Rich Picture, 3. Auxílio na organização das ideias durante o brainstorming | Excelente | Reunião; [Rich Picture (1.4.1)](docs/Base/1.4.1.evidencias_rich_picture.md) |
...
| Caio Antônio | 1. Contribuição na elaboração do Rich Picture e do Storyboard, 2. Auxílio na consolidação dos artefatos visuais | Excelente | Reunião; [Rich Picture (1.4.1)](docs/Base/1.4.1.evidencias_rich_picture.md) |
...
| Davi de Aguiar | 1. Revisão e validação do BPMN do admin, 2. Validação da jornada do usuário administrador garantindo coerência no processoos | Excelente | Reunião; [BPMN (1.3)](docs/Base/1.3.ModelagemBPMN.md) |
...
| Caio Antônio | 1. Auxílio na elaboração do BPMN  | Excelente | [BPMN (1.3)](docs/Base/1.3.ModelagemBPMN.md) |
